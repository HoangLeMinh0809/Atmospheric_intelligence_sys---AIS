...
PRESET_ONLINE_FEATURE_ALLOW_KAFKA_FALLBACK="${ONLINE_FEATURE_ALLOW_KAFKA_FALLBACK:-}"
...
[ -n "$PRESET_ONLINE_FEATURE_ALLOW_KAFKA_FALLBACK" ] && ONLINE_FEATURE_ALLOW_KAFKA_FALLBACK="$PRESET_ONLINE_FEATURE_ALLOW_KAFKA_FALLBACK"
...
DOCKER_EXEC_ARGS+=("-e" "ONLINE_FEATURE_ALLOW_KAFKA_FALLBACK=${ONLINE_FEATURE_ALLOW_KAFKA_FALLBACK}")
if [ -n "${DIRECTION:-}" ]; then
